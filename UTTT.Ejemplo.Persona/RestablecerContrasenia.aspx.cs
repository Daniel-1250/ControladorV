...
namespace UTTT.Ejemplo.Persona
{
    public partial class RestablecerContrasenia : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (token == null)
            {
                this.Response.Redirect("~/LoginUser.aspx");
            }
            else
            {
                idPersona = 1;
        ...
        DBPersona3Entities db = new DBPersona3Entities();
            ...
            try
            {
                if (txtNewPass.Text == txtNewPass2.Text && txtNewPass.Text == txtNewPass2.Text)
                {
                    ...
                    if (dcGlobal != null)
                    {
                        ...
                        var contra = (txtNewPass.Text);
                        // usuario.strContrasenia = txtNuevaContrasenia.ToString().Trim();
                        usuario.strPassword = Encrypt.GetSHA256(this.txtNewPass.Text.Trim());
